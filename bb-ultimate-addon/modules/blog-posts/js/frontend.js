...
(function($) {
    ...
    UABBBlogPosts = function( settings ){
        ...
        // TOD
        this.navigationStyle      = settings.navigation_style;
        console.log("JS -> "+this.navigationStyle);
    ...
    UABBBlogPosts.prototype = {
        ...
        _uabbBlogPostCarousel: function() {
            ...
            var appendArrowsHolder = '';
            if(this.navigationStyle=="custom"){
                    appendArrowsHolder = jQuery('.holder-arrow');
                    ...
                    appendArrows:  appendArrowsHolder,
